...
namespace RadGenGUI.Controls
{
    public class BetterGroupBox : GroupBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var path = GetRoundedRect(rect, this.AdjustForDPI(CornerRadius), textSize, textPoint);
        ...
        private GraphicsPath GetRoundedRect(Rectangle rect, int radius, Size textSize, Point textPoint)
        {
